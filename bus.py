...
def createpass():
	return render_template('createpass.html',registration=registration.query.order_by(registration.id.desc()).limit(1).all(),addbus=addbus.query.all())
	...
	def addbus_page():
		if request.method == 'POST':
			if not request.form['busnumber'] or not request.form['startroute'] or not request.form['endroute'] or not request.form['stopa'] or not request.form['stopb'] or not request.form['stopc'] or not request.form['stopd'] or not request.form['stope'] or not request.form['stopf'] or not request.form['stopg'] or not request.form['stoph'] or not request.form['stopi'] or not request.form['stopj']or not request.form['stopk']or not request.form['stopl']:
				...
				addb = addbus(request.form['busnumber'],request.form['startroute'],request.form['endroute'],request.form['stopa'],request.form['stopb'],request.form['stopc'],request.form['stopd'],request.form['stope'],request.form['stopf'],request.form['stopg'],request.form['stoph'],request.form['stopi'],request.form['stopj'],request.form['stopk'],request.form['stopl'])          
				db.session.add(addb)
				db.session.commit()
				flash('Record was successfully added')
